...
proc create_root_design { parentCell } {
  ...
  # Create instance: Vortex_top, and set properties
  set block_name Vortex_top
  set block_cell_name Vortex_top
  if { [catch {set Vortex_top [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Vortex_top eq "" } {
  ...
  set_property CONFIG.DATA_WIDTH {512} $axi_bram_ctrl


  # Create instance: axi_bram_ctrl_bram, and set properties
  set axi_bram_ctrl_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 axi_bram_ctrl_bram ]
  ...
  # Create instance: DCR_Vortex_0, and set properties
  set DCR_Vortex_0 [ create_bd_cell -type ip -vlnv user.org:user:DCR_Vortex:1.0 DCR_Vortex_0 ]
...
\
  ...
  connect_bd_intf_net -intf_net Vortex_top_m_axi_mem [get_bd_intf_pins Vortex_top/m_axi_mem] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_bram/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTB [get_bd_intf_pins axi_bram_ctrl/BRAM_PORTB] [get_bd_intf_pins axi_bram_ctrl_bram/BRAM_PORTB]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports led_8bits] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins axi_bram_ctrl/S_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins smartconnect_0/M02_AXI] [get_bd_intf_pins DCR_Vortex_0/S00_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD] [get_bd_intf_pins smartconnect_0/S01_AXI]

  # Create port connections
  connect_bd_net -net DCR_Vortex_0_dcr_vx_reset  [get_bd_pins DCR_Vortex_0/dcr_vx_reset] \
  ...
  [get_bd_pins DCR_Vortex_0/s00_axi_aresetn]
  connect_bd_net -net Net1  [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] \
  ...
  [get_bd_pins DCR_Vortex_0/s00_axi_aclk] \
  [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net Vortex_top_busy  [get_bd_pins Vortex_top/busy] \
  [get_bd_pins DCR_Vortex_0/busy]
  connect_bd_net -net dcr_wr_addr_0_1  [get_bd_pins DCR_Vortex_0/dcr_wr_addr] \
  [get_bd_pins Vortex_top/dcr_wr_addr] \
  [get_bd_pins ila_0/probe2]
  connect_bd_net -net dcr_wr_data_0_1  [get_bd_pins DCR_Vortex_0/dcr_wr_data] \
  [get_bd_pins Vortex_top/dcr_wr_data] \
  [get_bd_pins ila_0/probe3]
  connect_bd_net -net dcr_wr_valid_0_1  [get_bd_pins DCR_Vortex_0/dcr_wr_valid] \
  ...
  assign_bd_address -offset 0xA0100000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Vortex_top/m_axi_mem] [get_bd_addr_segs DCR_Vortex_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0000000 -range 0x00100000 -target_address_space [get_bd_addr_spaces Vortex_top/m_axi_mem] [get_bd_addr_segs axi_bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0110000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Vortex_top/m_axi_mem] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0100000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs DCR_Vortex_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0000000 -range 0x00100000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0110000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
