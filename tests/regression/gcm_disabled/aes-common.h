...
static inline aes_ushort AES_GET_BE16(const uint8_t *a)
{
	return (a[0] << 8) | a[1];
}

static inline void AES_PUT_BE16(uint8_t *a, aes_ushort val)
{
	a[0] = val >> 8;
	a[1] = val & 0xff;
}

static inline aes_ushort AES_GET_LE16(const uint8_t *a)
{
	return (a[1] << 8) | a[0];
}

static inline void AES_PUT_LE16(uint8_t *a, aes_ushort val)
{
	a[1] = val >> 8;
	a[0] = val & 0xff;
}

static inline aes_uint AES_GET_BE24(const uint8_t *a)
{
	return (a[0] << 16) | (a[1] << 8) | a[2];
}

static inline void AES_PUT_BE24(uint8_t *a, aes_uint val)
{
	a[0] = (val >> 16) & 0xff;
	a[1] = (val >> 8) & 0xff;
	a[2] = val & 0xff;
...
static inline aes_uint AES_GET_BE32(const uint8_t *a)
{
	return (a[0] << 24) | (a[1] << 16) | (a[2] << 8) | a[3];
}

static inline void AES_PUT_BE32(u_char *a, aes_uint val)
{
	a[0] = (val >> 24) & 0xff;
	a[1] = (val >> 16) & 0xff;
	a[2] = (val >> 8) & 0xff;
...
static inline aes_uint AES_GET_LE32(const uint8_t *a)
{
	return (a[3] << 24) | (a[2] << 16) | (a[1] << 8) | a[0];
}

static inline void AES_PUT_LE32(uint8_t *a, aes_uint val)
{
	a[3] = (val >> 24) & 0xff;
	a[2] = (val >> 16) & 0xff;
	a[1] = (val >> 8) & 0xff;
...
static inline aes_ulong AES_GET_BE64(const uint8_t *a)
{
...
static inline void AES_PUT_BE64(uint8_t *a, aes_ulong val)
{
	a[0] = val >> 56;
	a[1] = val >> 48;
	a[2] = val >> 40;
...
static inline aes_ulong AES_GET_LE64(const uint8_t *a)
{
...
static inline void AES_PUT_LE64(uint8_t *a, aes_ulong val)
{
	a[7] = val >> 56;
	a[6] = val >> 48;
	a[5] = val >> 40;
