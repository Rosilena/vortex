...
#define SIZE_KEY  (LEN_KEY * sizeof(uint8_t))
#define SIZE_IN   (LEN_IN  * sizeof(uint8_t))
#define SIZE_OUT  (LEN_OUT * sizeof(uint8_t))
#define SIZE_IV   (LEN_IV  * sizeof(uint8_t))

#if defined(AES256)
  uint8_t key_u8[LEN_KEY] = { 0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b, 0x73, 0xae, 0xf0, 0x85, 0x7d, 0x77, 0x81,
...
#elif defined(AES192)
  uint8_t key_u8[LEN_KEY] = { 0x8e, 0x73, 0xb0, 0xf7, 0xda, 0x0e, 0x64, 0x52, 0xc8, 0x10, 0xf3, 0x2b, 0x80, 0x90, 0x79, 0xe5, 
...
#elif defined(AES128)
  uint8_t key_u8[LEN_KEY] = { 0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6, 0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f, 0x3c };
